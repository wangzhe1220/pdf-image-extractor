 ...
 * @see org.apache.pdfbox.text.PDFTextStripperByArea
 */
public class PDFTextStripperByImageArea extends PDFTextImageTitleStripper
{
     ...
     */
    public PDFTextStripperByImageArea() throws Exception
    {
